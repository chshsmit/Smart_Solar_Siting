//
// Created by Sam Singh on 5/9/18.
//

#include "solarsitingucsc_smartsolarsiting_Controller_NativePanorama.h"
...
Java_solarsitingucsc_smartsolarsiting_Controller_NativePanorama_processPanorama
