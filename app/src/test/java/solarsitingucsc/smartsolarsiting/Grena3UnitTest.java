...
public class Grena3UnitTest {
    ...
    GregorianCalendar newDate = new GregorianCalendar(2018, Calendar.MARCH, 9, 14, 47);
    AzimuthZenithAngle newAngle = Grena3.calculateSolarPosition(newDate, 36.9, -122.03, 68);
    
    //The expected azimuth for March 9th, 2018 at 2:47 is 228 degrees
    @Test
    public void azimuthReturnedCorrectly() throws Exception {
        assertEquals(228.0, newAngle.getAzimuth(), DELTA);
    }

    //The expected zenith for March 9th, 2018 at 2:47 is 54 degrees
    @Test
